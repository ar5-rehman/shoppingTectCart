package com.clothing.shoppingcarts.base.viewmodel

import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.clothing.shoppingcarts.BuildConfig
import com.clothing.shoppingcarts.base.exception.ServerException
import com.clothing.shoppingcarts.base.extension.asLiveData
import com.clothing.shoppingcarts.network.responses.ErrorWithSessionExpired
        ...
        try {
            ...
            val serverException =
                jsonAdapter.fromJson(httpException.response()?.errorBody()?.string() ?: "")
                    ?: return ErrorWithSessionExpired(
            ...
            return ErrorWithSessionExpired(
                ...
                serverException.data?.sessionExpired ?: false
            )
        } catch (e: Exception) {
            e.printStackTrace()
